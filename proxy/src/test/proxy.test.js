...
test('unwrapping repairs leaked unicode punctuation escape remnants', () => {
    const raw = '{"response":"The hoodie was long goneu2014somewhere. He didn\\\\u2019t look back. \u201CHi\u201D..."}';
    const unwrapped = tryUnwrapStructuredOutput(raw, {
        schemaMode: 'pattern',
        newlineToken: '<NL>',
    });

    assert.equal(unwrapped, 'The hoodie was long gone-somewhere. He didn\'t look back. "Hi"...');
});
